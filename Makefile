srcdir = /home/johnny/program_files/php-7.0.25/ext/arr_extension
builddir = /home/johnny/program_files/php-7.0.25/ext/arr_extension
top_srcdir = /home/johnny/program_files/php-7.0.25/ext/arr_extension
top_builddir = /home/johnny/program_files/php-7.0.25/ext/arr_extension
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = nawk
shared_objects_arr_extension = arr_extension.lo
PHP_PECL_EXTENSION = arr_extension
PHP_MODULES = $(phplibdir)/arr_extension.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /home/johnny/program_files/php-7.0.25/ext/arr_extension/modules
